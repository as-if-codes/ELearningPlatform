...
if (!isset($_SESSION['user'])) {
  ...
  <div class="logout" style="text-align: right;">
      ...
      <center>  <h2 style="color: #333;">Welcome, <?= $user['username'] ?>!</h2>
        ...
        <div class="main-content" style="padding: 20px; text-align: center; display:flex ">
    ...
    <div class="register-section" id="create-course" style="background-color: #a8f5db; padding: 20px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); text-align: left; margin: 20px auto; max-width: 400px;">
        <h3>Create a New Course</h3>
        <form action="addcourse" method="POST">
            <label for="course_title">Course Title:</label>
            <input type="text" id="course_title" name="course_title" class="input-field" required><br><br>
            
            <label for="description">Description:</label>
            <textarea id="description" name="description" class="input-field" required></textarea><br><br>

            <button type="submit" class="submit-button" style="padding: 10px 20px; font-size: 16px; border-radius: 15px; background-color: #000; color: #fff; border: 2px solid goldenrod; cursor: pointer;">Create Course</button>
        </form>
    </div>
</div>
    <footer class="footer">
